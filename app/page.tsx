  ...
  return (
    <div className="flex flex-col items-center w-full h-full bg-white p-14">
      <div className="flex flex-col items-center mb-10">
        <h1 className="text-[32px] font-[700] mb-5">Антон Филиппович</h1>
      ...
      <div className="flex flex-col items-center mb-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            className="contact-button"
          >
            <Image src={instIcon} alt="Instagram Icon" width={40} height={40} />
          </a>
          <a
          ...
          <a
            ...
            className="contact-button"
          >
            <Image src={telIcon} alt="Telephone Icon" width={40} height={40} />
          </a>
        </div>
      </div>
      <div>
